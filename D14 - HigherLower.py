from D14A_HLart import logo,vs
from D14B_gameData import data
import random
...
def format_data(account):
  ...
  # print(f'{name}: {account["followers"]}')
...
Instagram has more followers, so choice A is correct. However, 
the subsequent comparison should be between Selena Gomez (the new A) and someone else. The reason is that everything in our list has fewer followers than Instagram. 
